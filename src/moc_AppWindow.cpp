...
QT_MOC_LITERAL(9, 101, 10)
    ...
    "AppWindow\0app_newgame\0\0app_reset\0"
    "draw_wireframe\0draw_face\0draw_multicoloured\0"
    "speed_slow\0speed_medium\0speed_fast\0"
};
...
void AppWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->app_newgame(); break;
        case 1: _t->app_reset(); break;
        case 2: _t->draw_wireframe(); break;
        case 3: _t->draw_face(); break;
        case 4: _t->draw_multicoloured(); break;
        case 5: _t->speed_slow(); break;
        case 6: _t->speed_medium(); break;
        case 7: _t->speed_fast(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
